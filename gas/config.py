...
class Config(object):  
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = "arn:aws:sns:us-east-1:127134666975:honglibu_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = "arn:aws:sns:us-east-1:127134666975:honglibu_job_results"
  AWS_SNS_JOB_RESTORE_TOPIC = "arn:aws:sns:us-east-1:127134666975:honglibu_job_restore"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "honglibu_annotations"

  # Stripe API keys
  STRIPE_PUBLIC_KEY = "pk_test_VSGhyrf9JTQSOq94cxy19zj1"
  STRIPE_SECRET_KEY = "sk_test_1lhqry3eeNDD7gAGLmITexNL"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "honglibu@ucmpcs.org"
